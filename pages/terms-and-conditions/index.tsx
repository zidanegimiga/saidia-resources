...
const TermsAndConditions = () => {
  return (
    <div className={styles.pageContent}>
      <h1>Terms of Use</h1>
      <p>
        The Terms of Use (TOU) for Saidia, last updated in June 2023,
        outline the agreement between users (&quot;you&quot;) and Saidia owned
        by Creatives Garage. regarding the use of the website. By accessing or
        using the site, you agree to be bound by these TOU and the accompanying
        Privacy Policy.
      </p>
      <h3>Restrictions</h3>
      <ul>
        <li>
          You agree not to interfere with the proper functioning of the site or
          attempt to do so.
        </li>
        <li>
        ...
        <li>
          You must not violate any copyright or intellectual property rights of
          another party.
        </li>
        <li>
          Actions that could damage, disable, overburden, or impair the
          site&#39;s infrastructure or Saidia&#39; network system are
          prohibited.
        </li>
        <li>
          Unauthorized access to software, accounts, computer systems, or
          networks connected to Saidia is strictly forbidden.
        </li>
        <li>
          Actions that interfere with others&#39; use and enjoyment of the site
          are prohibited.
        </li>
        <li>
      ...
      <ul>
        <li>
          Saidia and its licensors own the site, including all intellectual
          property rights.
        </li>
        <li>
          Saidia makes no warranties, express or implied, regarding
          non-infringement, merchantability, or fitness for a particular
          purpose.
        </li>
        <li>
          Any reliance on the quality or performance of the site is at your own
          risk.
        </li>
        <li>
          Saidia is not liable for damages arising from the site or losses
      ...
      <ul>
        <li>
          Saidia is not liable for any direct or indirect losses or damages
          related to the site, its use, or errors in its operation.
        </li>
        <li>
          This includes damages to users&#39; computers, devices, or equipment,
          even if Saidia should have known of the possibility of such damages.
        </li>
        <li>
          Your sole remedy against Saidia for dissatisfaction with the site is
          to stop using it.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          If a user is a minor, but meets the minimum age requirement, they need
      ...
      <ul>
        ...
        <li>
          Saidia can disable access to minors who do not meet the applicable
      ...
      <ul>
        <li>
          You agree to defend and hold harmless Saidia, its affiliates,
          officers, directors, and employees from any damages, costs, losses, or
          liabilities arising from your breach of the TOU or any claim related
      ...
      <ul>
        <li>
          ...
          owned or controlled by Saidia.
        </li>
        <li>
          Saidia assumes no responsibility for the content, privacy policies,
      ...
      <ul>
        <li>
          Saidia respects intellectual property rights and will remove
      ...
      <ul>
        <li>
          Notices from Saidia will be sent to the contact information provided
          during registration.
        </li>
        <li>
          These TOU do not create a principal-agent, partnership, or joint
          venture relationship between Saidia and users.
        </li>
        <li>
        ...
        <li>
          Waivers, assignments, and severability provisions are included in the
          TOU.
        </li>
        <li>
