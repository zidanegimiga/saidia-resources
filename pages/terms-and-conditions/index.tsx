...
const TermsOfService = () => {
  ...
  return (
    <div className={styles.pageContainer}>
      <Head>
        <title>Saidia - Terms of service</title>
      </Head>
      <Nav/>
      <div className={styles.pageContent}>
        <h1>Terms of Use</h1>
        <p>
          The Terms of Use (TOU) for Saidia, last updated in August 2023,
          outline the agreement between users (&quot;you&quot;) and Saidia
        ...
        <ul>
          ...
          <li>
            ...
            equipment, even if Saidia should have known of the possibility of
            such damages.
          </li>
          <li>
            Your sole remedy against Saidia for dissatisfaction with the site
            is to stop using it.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Saidia assumes no responsibility for the content, privacy
        ...
        <ul>
          <li>
            Notices from Saidia will be sent to the contact information
