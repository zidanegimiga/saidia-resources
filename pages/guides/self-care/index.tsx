...
export default function SelfCare() {
  return (
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.article} id="mindfulness-exercises">
        <h2>Mindfullness Exercises</h2>
        <p>
          Mindfulness exercises can help you cultivate present-moment awareness,
          reduce stress, and promote overall well-being. Here are a few
        ...
        <ol>
          ...
          <li>
            ...
            of your body, starting from your toes and moving upward. Notice any
            sensations, tension, or areas of relaxation. Stay present with each
            part of your body as you scan through it.
          </li>
          <li>
            ...
            two things you can smell, and one thing you can taste. Engaging your
            senses in this way helps anchor you to the present moment.
          </li>
          <li>
            Mindful Eating: Choose a small piece of food, such as a raisin or a
            slice of fruit. Before eating, observe its colors, texture, and
            shape. Slowly take a bite and pay attention to the flavors,
            sensations, and the act of chewing and swallowing. Notice the entire
            experience of eating mindfully.
          </li>
          <li>
        ...
        <p>
          ...
          duration as you become more comfortable. Find what resonates with you
          and incorporate mindfulness into your daily routine for greater
          clarity and presence in your life.
        </p>
      </div>
      <div className={styles.article} id="relaxation-techniques">
        <h2>Relaxation Techniques</h2>
        <p>
          Relaxation techniques can help reduce stress, promote calmness, and
          induce a state of relaxation. Here are a few relaxation techniques you
          can try:
        </p>
        <ol>
          <li>
            ...
            air, and exhale slowly through your mouth. Focus on your breath and
            let go of any tension or stress with each exhale.
          </li>
          <li>
            Progressive Muscle Relaxation: Start by tensing and then releasing
            different muscle groups in your body, one at a time. Begin with your
            toes, move up to your legs, abdomen, chest, arms, and finally to
            your face. Hold the tension for a few seconds and then release,
          ...
          <li>
            Visualization: Picture yourself accomplishing a goal or engaging in
            an activity that brings you joy. Imagine the details, emotions, and
            sensations associated with that experience. This can help shift your
            focus to positive and calming thoughts.
          </li>
          <li>
          ...
          <li>
            ...
            strokes, colors, and patterns. This simple and creative task can be
            relaxing and help shift your focus away from stressors.
          </li>
          <li>
            Progressive Relaxation Music: Listen to soothing instrumental music
            or nature sounds specifically designed for relaxation. Let the
            calming melodies and rhythms help you unwind and create a peaceful
            ambiance
          </li>
          <li>
            Journaling: Write down your thoughts, worries, or concerns in a
            journal. This can be a cathartic practice that allows you to process
            your emotions and gain clarity. Reflect on positive aspects of your
          ...
          <li>
            Meditation Apps and Relaxation Tools: Explore meditation apps, such
            as Headspace, Calm, or Insight Timer, which offer guided meditations
            and relaxation exercises. Additionally, consider using relaxation
            tools like stress balls, weighted blankets, or aromatherapy to
            enhance relaxation.
          </li>
        </ol>
        <p>
          ...
          Incorporate these practices into your routine regularly to experience
      ...
      <div className={styles.article} id="selfcare-apps">
        ...
        <ol>
          <li>
            Headspace: Headspace offers guided meditation sessions, mindfulness
            exercises, and sleep aids to help reduce stress, improve focus, and
            promote relaxation.
          </li>
          <li>
          ...
          <li>
            Breathe: Breathe offers guided meditations, relaxing music, bedtime
            stories, and breathing exercises to support mindfulness, stress
      ...
      <div className={styles.article} id="queer-friendly-therapist">
        ...
        <p>
          ...
          ensuring a safe and supportive therapeutic environment. Here are some
          indicators that can help you assess a therapist&apos;s
          queer-friendliness:
        </p>
        <ol>
          <li>
            Training and Experience: Inquire about the therapist&apos;s training
            and experience working with LGBTQ+ clients. Ask if they have
            received specific education or workshops on LGBTQ+ issues, gender
            identity, and sexual orientation. Therapists who have sought out
            additional training or have experience working with queer clients
            are more likely to be knowledgeable and affirming.
          </li>
          <li>
            Affirming Language: Listen to the language the therapist uses during
            conversations or in their written materials. Queer-friendly
          ...
          <li>
            ...
            sexual orientations and gender identities. They should create a safe
            space where you feel comfortable discussing your experiences and
            concerns without fear of being judged or stigmatized.
          </li>
          <li>
            Knowledge of LGBTQ+ Issues: A therapist who is queer-friendly should
            have a basic understanding of LGBTQ+ issues, including common
            challenges faced by the community, mental health disparities, and
            the impact of minority stress. They should be able to provide
            appropriate support and address your specific needs as an LGBTQ+
            individual.
          </li>
          <li>
        ...
        <p>
          It is important to remember that the therapist-client relationship is
          unique, and personal compatibility is essential. Trust your instincts
          and consider having an initial consultation or phone call with the
          therapist to discuss their approach, values, and any concerns you may
          have. This can help you gauge their queer-friendliness and determine
          if they are the right fit for your needs.
        </p>
      </div>
      <div className={styles.article} id="mental-health-support-orgs">
        <h2>
          Which LGBTQ+ organizations provide support and mental therapy sessions
          in Kenya?
        </h2>
        <p>
          In Kenya, there are several LGBTQ+ organizations that provide support
          and mental therapy services for the community. Here are a few
          organizations that offer mental health support to the LGBTQ+ community
          in Kenya:
        </p>
        <ol>
          <li>
            ...
            of LGBTQ+ individuals in Kenya. They provide resources, support, and
            counseling services for the community, including mental health
            support.
          </li>
          <li>
          ...
          <li>
            ...
            rights of LGBTQ+ individuals in Kenya. They provide legal support,
            advocacy services, and resources that can include mental health
        ...
        <p>
          ...
          therapists or counselors. However, they can often refer individuals to
          mental health professionals who are LGBTQ+ affirming or have
